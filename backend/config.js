...
export const TEST_ACCOUNT_EMAIL = String(process.env.TEST_ACCOUNT_EMAIL || "").trim().toLowerCase();
export const TEST_ACCOUNT_PASSWORD = String(process.env.TEST_ACCOUNT_PASSWORD || "").trim();
export const TEST_ACCOUNT_NAME = process.env.TEST_ACCOUNT_NAME || "Compte test AFRIX";
export const GRSCOIN_PRICE_USDT = Math.max(0, Number(process.env.GRSCOIN_PRICE_USDT || 0.357142857143));
